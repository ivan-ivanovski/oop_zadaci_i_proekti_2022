...
int main() {
    ...
    int tip;
    float golemina;
    OperativenSistem os[brojOperativniSistemi];
    for (int i = 0; i<brojOperativniSistemi; i++){
        cin>>ime;
        cin>>verzija;
        cin>>tip;
        cin>>golemina;
        os[i] = OperativenSistem(ime, verzija, (Tip)tip, golemina);
        repozitorium.dodadi(os[i]);
    }
    ...
    cin>>tip;
    cin>>golemina;
    OperativenSistem os2 = OperativenSistem(ime, verzija, (Tip)tip, golemina);
    cout<<"=====Brishenje na operativen sistem====="<<endl;
    repozitorium.izbrishi(os2);
    repozitorium.pecatiOperativniSistemi();
    return 0;
}
